...
function LivIconsEvoDefaults() {
    ...
    var default_options = {
        ...
        pathToFolder: 'assets/images/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
        ...
        strokeColor: '#7503de', //when style opt is 'filled' or 'lines' or ('lines-alt' / 'linesAlt')
    ...
    if (default_options.pathToFolder === '<?php echo base_url();?>assets/js/tools/LivIconsEvo.defaults.js') {
